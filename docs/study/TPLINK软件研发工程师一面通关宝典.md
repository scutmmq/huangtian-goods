...
## 二、普联定制版 2 分钟黄金自我介绍（直击通信心智）

> **设计思路**：突出华南理工大学的学科背景优势；主动将软件开发经验与 TP-LINK 的“**智能硬件、设备通信、海量长连接**”特征绑定，预设让面试官顺着提问 Netty 和计网。

### 🗣️ 口述实战话术（建议背熟，控制在 100~120 秒）：

> “面试官您好，我叫**莫明钦**，来自**华南理工大学**。非常高兴能参加今天 TP-LINK 软件研发工程师的面试！
>
> 在校期间，我系统深造了计算机网络、操作系统、分布式系统等核心课程，积累了扎实的理论功底；工程方面，我长期深耕 **Java 高并发系统开发、网络通信与分布式后端架构**。
>
> 我的实战经验主要体现在两段企业级实习与高并发项目实战中：
>
> 第一段是在**云智易（AIoT平台）**担任后端研发实习生：
> 当时面对千万级智能家居与安防设备的同时在线通信诉求，我深度参与了基于 **Netty** 的百万级长连接网关设计。在项目中，我负责设计并落地了**基于魔数与长度字段的自定义二进制私有通信协议**，彻底解决了 TCP 粘包与半包问题；同时借助 **IdleStateHandler** 构建了分级心跳保活机制与超时剔除，将因弱网抖动造成的服务端连接句柄泄漏降低了 90% 以上。
>
> 第二段是在**凯通科技**负责中国联通/移动的电信级网络运营中台研发：
> 针对千万级网络工单与设备拓扑数据的高频慢查询，我通过 **EXPLAIN 深度分析结合索引下推（ICP）与延迟关联重构**，将核心慢 SQL 耗时从 4.2 秒大幅压缩至 80 毫秒以内；并通过重构大事务边界，彻底消除了数据库连接池耗尽告警。
>
> 此外，我自己独立架构了**荒天微服务商城系统**，运用 Redis 分布式锁与令牌桶算法攻克了秒杀高并发防超卖与防刷难题。
>
> 我了解到 TP-LINK 在家庭与企业级网络设备、Wi-Fi 7 技术以及智能安防 IoT 生态领域处于全球领先地位。我过往在**底层网络通信管道、高并发长连接网关与系统稳定性治理**的积累，与普联的软件研发方向高度契合。非常渴望能够加入 TP-LINK，为全球用户带来极速、稳定的连接体验！谢谢面试官！”
...
#### 追问 2：TCP 是面向字节流的，你们是如何设计协议解决粘包、半包问题的？
- **答题逻辑**：
